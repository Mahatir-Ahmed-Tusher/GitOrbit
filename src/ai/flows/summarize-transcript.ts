...
/**
 * @fileOverview Summarizes meeting transcripts by extracting key discussion points and action items.
 *
...
const SummarizeTranscriptOutputSchema = z.object({
  summary: z.string().describe('A summary of the meeting transcript.'),
  actionItems: z.string().describe('A list of action items extracted from the transcript.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following meeting transcript. List discussion points and action items:\n\n{{transcript}}`,
});
